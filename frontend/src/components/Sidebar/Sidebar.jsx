  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: 10, color: muted, marginLeft: 36 }}>
          Serviços Gerais · v2.0
        </div>
      </div>
...
function SettingsModal({
  ...
  const ROLES = {
    AGENT:
      "Vê todos os tickets, comenta em qualquer um, não pode mudar status ou prioridade.",
    ADMIN:
      "Vê e edita todos os tickets, muda status e prioridade. Não cria ou deleta usuários.",
