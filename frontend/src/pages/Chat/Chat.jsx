...
export default function Chat() {
  ...
  return (
    <div style={{ display: "flex", height: "100vh", background: bg, fontFamily: "'Inter', system-ui, sans-serif" }}>
      <div style={{ width: 300, borderRight: `1px solid ${border}`, display: "flex", flexDirection: "column" }}>
        <div style={{ padding: 16, borderBottom: `1px solid ${border}` }}>
          <div style={{ fontSize: 16, fontWeight: 700, color: textColor, marginBottom: 10 }}>Chat</div>
          <input
